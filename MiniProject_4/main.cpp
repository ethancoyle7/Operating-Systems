...
int main()
{
    ...
    //create vector frame that will store the pages and reference bit
    vector<pair<int,bool>> frames(Frames);
    //frame set from start to page no -1 and then the reference bit for this is 0 for second chance
